...
const PrivacyPolicy = () => {
  return (
    <div className="container PrivacyPolicy">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &ldquo;Our&rdquo; in this Agreement) refers to Intevia Healthcare
            LLC, Suite 5 3rd Floor, Alpha House, 296 Kenton Road, Harrow, United
            Kingdom, HA3 8DD.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Intevia Healthcare, accessible
            from{" "}
            <a
              href="https://inteviahealthcare.co.uk/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://inteviahealthcare.co.uk/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: info@inteviahealthcare.co.uk</li>
      </ul>
    </div>
  );
};
